  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: DatabaseHelper.instance.getRecipesByCategory(widget.category),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            log('No recipes found for category: ${widget.category}');
            return const Center(
              child: Text(
          ...
          log('Recipes fetched for category ${widget.category}: $recipes');
